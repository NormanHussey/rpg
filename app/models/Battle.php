<?php
  ...
  class Battle {
    ...
    public function updatePlayerData() {
      ...
      $this->db->query('UPDATE users SET health = :health, maxHealth = :maxHealth, stamina = :stamina, maxStamina = :maxStamina, strength = :strength, agility = :agility, dexterity = :dexterity, luck = :luck, xp = :xp, level = :level WHERE id = :id');
